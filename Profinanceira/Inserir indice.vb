Public Class form_inserir_indice
    ...
    Private Sub form_inserir_indice_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        On Error GoTo Err_inserir_indice_Click
        Select Case form_sistema_price.caixacombo_le_add_indices.Text
            ...
            Case "Sistema PRICE"
                ...
                End If
        End Select
Exit_inserir_indice_Click:
        Exit Sub

Err_inserir_indice_Click:
        MsgBox(Err.Description)
        Resume Exit_inserir_indice_Click
    End Sub
    ...
    Private Sub btn_mudar_indice_cancelar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_mudar_indice_cancelar.Click
        On Error GoTo Err_mudar_indice_cancelar_Click
        Me.Close()
Exit_mudar_indice_cancelar_Click:
        Exit Sub

Err_mudar_indice_cancelar_Click:
        MsgBox(Err.Description)
        Resume Exit_mudar_indice_cancelar_Click
    End Sub
    ...
    Private Sub btn_mudar_indice_ok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_mudar_indice_ok.Click
        On Error GoTo Err_mudar_indice_ok_Click
        ...
        Select Case form_sistema_price.caixacombo_le_add_indices.Text
            ...
            Case "Sistema PRICE"
                ...
                End If
        End Select
Exit_mudar_indice_ok_Click:
        Exit Sub

Err_mudar_indice_ok_Click:
        MsgBox(Err.Description)
        Resume Exit_mudar_indice_ok_Click
    End Sub
